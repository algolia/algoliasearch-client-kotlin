...
class DSLFilters(
     ...
     */
    operator fun FilterGroup<*>.unaryPlus() {
     ...
     */
    fun and(block: DSLGroupFilter.() -> Unit) {
     ...
     */
    fun orFacet(block: DSLGroupFacet.() -> Unit) {
     ...
     */
    fun orNumeric(block: DSLGroupNumeric.() -> Unit) {
     ...
     */
    fun orTag(block: DSLGroupTag.() -> Unit) {
        +FilterGroup.Or.Tag(DSLGroupTag(block))
    }

    companion object : DSL<DSLFilters, Set<FilterGroup<*>>> {
