...
class DSLNumericFilters(
     ...
     */
    operator fun FilterGroup<Filter.Numeric>.unaryPlus() {
     ...
     */
    fun and(block: DSLGroupNumeric.() -> Unit) {
     ...
     */
    fun or(block: DSLGroupNumeric.() -> Unit) {
        +FilterGroup.Or.Numeric(DSLGroupNumeric(block))
    }

    companion object : DSL<DSLNumericFilters, Set<FilterGroup<Filter.Numeric>>> {
