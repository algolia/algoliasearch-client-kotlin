...
class DSLTagFilters(
     ...
     */
    operator fun FilterGroup<Filter.Tag>.unaryPlus() {
     ...
     */
    fun and(block: DSLGroupTag.() -> Unit) {
     ...
     */
    fun or(block: DSLGroupTag.() -> Unit) {
        +FilterGroup.Or.Tag(DSLGroupTag(block))
    }

    companion object : DSL<DSLTagFilters, Set<FilterGroup<Filter.Tag>>> {
