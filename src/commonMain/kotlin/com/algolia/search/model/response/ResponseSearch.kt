...
public data class ResponseSearch(
    ...
    public data class Hit(
        ...
        /**
         * When two consecutive results have the same value for the attribute used for “distinct”,
         * this field is used to distinguish between them. Only returned when [Query.distinct] is non-zero.
         */
        ...
        /**
         * Highlighted attributes. Each attribute contains the following attributes.
         * Only returned when [Query.attributesToHighlight] or [Settings.attributesToHighlight] is non-empty.
         */
         ...
         * Highlighted attributes. Each attribute contains the following attributes.
         * Only returned when [Query.attributesToHighlight] or [Settings.attributesToHighlight] is non-empty.
         * Use this method for getting [HighlightResult] for [Attribute] with an array-based value.
         */
         ...
         * Highlighted attributes. Each attribute contains the following attributes.
         * Only returned when [Query.attributesToHighlight] or [Settings.attributesToHighlight] is non-empty.
         * Use this method for getting [HighlightResult] for [Attribute] with nested values in the form of a Json object.
         */
        ...
        /**
         * Snippeted attributes. Only returned when [Query.attributesToSnippet] is non-empty.
         */
        ...
        /**
         * Snippeted attributes. Only returned when [Query.attributesToSnippet] is non-empty.
         * Use this method for getting [SnippetResult] for [Attribute] with an array-based value.
         */
