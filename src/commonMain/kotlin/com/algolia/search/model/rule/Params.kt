...
public data class Params(
    @SerialName(KeyAutomaticFacetFilters) var automaticFacetFilters: List<AutomaticFacetFilters>? = null,
    @SerialName(KeyAutomaticOptionalFacetFilters) var automaticOptionalFacetFilters: List<AutomaticFacetFilters>? = null,
    @SerialName(KeyQuery) var query: QueryOrEdits? = null,
    /**
