...
sealed class Partial {
     ...
     */
    data class Update internal constructor(
        override val attribute: Attribute,
        override val value: JsonElement
    ) : Partial() {

        constructor(attribute: Attribute, value: String) : this(attribute, JsonLiteral(value))

        constructor(attribute: Attribute, value: Boolean) : this(attribute, JsonLiteral(value))

        constructor(attribute: Attribute, value: Number) : this(attribute, JsonLiteral(value))

        constructor(attribute: Attribute, value: JsonArray) : this(attribute, value as JsonElement)

        constructor(attribute: Attribute, value: JsonObject) : this(attribute, value as JsonElement)
    }
