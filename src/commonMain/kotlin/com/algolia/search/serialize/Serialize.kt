...
import com.algolia.search.apikey.APIKeyRequest
...
internal fun APIKeyRequest.encodeNoNulls(): JsonObject {
    return toJsonObject(APIKeyRequest.serializer()).encodeNoNulls()
}
