...
sealed class Ranking(override val raw: String) : Raw<String> {
    ...
    data class Asc(val attribute: com.algolia.search.saas.model.Attribute) : Ranking("$KeyAsc($attribute)")

    data class Desc(val attribute: com.algolia.search.saas.model.Attribute) : Ranking("$KeyDesc($attribute)")
