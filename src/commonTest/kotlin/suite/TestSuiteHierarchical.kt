...
internal class TestSuiteHierarchical {
    ...
    fun hierarchicalDisjunctive() {
        runBlocking {
            ...
            val objects = load(ListSerializer(JsonObjectSerializer), "hierarchical_disjunctive.json")
    ...
    fun hierarchical() {
        runBlocking {
            ...
            val objects = load(ListSerializer(JsonObjectSerializer), "hierarchical.json")
