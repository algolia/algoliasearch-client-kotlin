...
public class SearchClient(
   ...
   * efficient to get a list of object IDs with the
   ...
   * the existing index and copy the data to the replica indices. - Related guide:
   ...
   * true. - If the index doesn't exist yet, this method creates a new index. - You can use any
