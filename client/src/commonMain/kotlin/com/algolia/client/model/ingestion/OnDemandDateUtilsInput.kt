 ...
 *
 * @param startDate Earliest date in RFC 3339 format of the extracted data from Big Query.
 * @param endDate Latest date in RFC 3339 format of the extracted data from Big Query.
 * @param mapping
 */
@Serializable
