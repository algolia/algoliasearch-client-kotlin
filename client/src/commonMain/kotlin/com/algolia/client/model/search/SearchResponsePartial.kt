 ...
 * @param extensions
 */
@Serializable(SearchResponsePartialSerializer::class)
public data class SearchResponsePartial(
...
internal object SearchResponsePartialSerializer : KSerializer<SearchResponsePartial> {

  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SearchResponsePartial") {
      ...
      element<List<Hit>>("hits", isOptional = true)
  ...
  override fun deserialize(decoder: Decoder): SearchResponsePartial {
    ...
    return SearchResponsePartial(
      ...
      hits = tree["hits"]?.let { input.json.decodeFromJsonElement(it) },
  ...
  override fun serialize(encoder: Encoder, value: SearchResponsePartial) {
    ...
    val json = buildJsonObject {
      ...
      value.hits?.let { put("hits", output.json.encodeToJsonElement(it)) }
