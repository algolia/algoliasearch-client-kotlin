 ...
 *
 * @param automaticFacetFilters Filter recommendations that match or don't match the same `facet:facet_value` combination as the viewed item.
...
public data class ParamsConsequence(
  ...
  @SerialName(value = "automaticFacetFilters") val automaticFacetFilters: List<AutoFacetFilter>? = null,
